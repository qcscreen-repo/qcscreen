...
############## simulation 1b p=1000 alpha=0.5 ##############
...
############## simulation 1b p=1000 alpha=0.75 ##############
generate_model_1b <- function(n = 400, p = 1000, seed = NULL) {
  if (!is.null(seed)) set.seed(seed)
...
############## simulation 1b p=5000 alpha=0.5 ##############
generate_model_1b <- function(n = 400, p = 5000, seed = NULL) {
  if (!is.null(seed)) set.seed(seed)
...
############## simulation 1b p=5000 alpha=0.75 ##############
generate_model_1b <- function(n = 400, p = 5000, seed = NULL) {
  if (!is.null(seed)) set.seed(seed)
